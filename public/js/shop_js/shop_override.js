jQuery(function($){
    ...
    $(".renewal_itemform select.it_supply").on("shop_sel_supply_process", function(e, param){
        ...
        add_sel_option = (function() {
            ...
            return function() {
                ...
                if( $(".renewal_itemform").length ){
                    ...
                    opt += "<input type=\"text\" name=\"ct_qty["+item_code+"][]\" value=\"1\" class=\"num_input\" size=\"5\"  onKeyup=\"this.value=this.value.replace(/[^0-9]/g,'');\">";

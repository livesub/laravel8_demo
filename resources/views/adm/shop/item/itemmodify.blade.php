            ...
            <table>
                <tr>
                    ...
                    @php
                        ...
                        if($item_info->item_sc_type == 0) $item_sc_type0 = "selected";
                        else if($item_info->item_sc_type == 1) $item_sc_type1 = "selected";
                        else if($item_info->item_sc_type == 2) $item_sc_type2 = "selected";
                        else if($item_info->item_sc_type == 3) $item_sc_type3 = "selected";
                        else if($item_info->item_sc_type == 4) $item_sc_type4 = "selected";
                    @endphp
                        <select name="item_sc_type" id="item_sc_type">
                            <option value="0" {{ $item_sc_type0 }}>쇼핑몰 기본설정 사용</option>
                            <option value="1" {{ $item_sc_type1 }}>무료배송</option>
                            <option value="2" {{ $item_sc_type2 }}>조건부 무료배송</option>
                            <option value="3" {{ $item_sc_type3 }}>유료배송</option>
                            <option value="4" {{ $item_sc_type4 }}>수량별 부과</option>
                        </select>
                    </td>
                </tr>
                ...
                <tr id="sc_con_method">
                    ...
                    @php
                        ...
                        if($item_info->item_sc_method == 0) $item_sc_method0 = "selected";
                        else if($item_info->item_sc_method == 1) $item_sc_method1 = "selected";
                        else if($item_info->item_sc_method == 2) $item_sc_method2 = "selected";
                    @endphp
                        <select name="item_sc_method" id="item_sc_method">
                            <option value="0" {{ $item_sc_method0 }}>선불</option>
                            <option value="1" {{ $item_sc_method1 }}>착불</option>
                            <option value="2" {{ $item_sc_method2 }}>사용자선택</option>
                        </select>
                    </td>
                </tr>
                <tr id="sc_con_basic">
                ...
                <tr id="sc_con_minimum">
                    ...
                    <td>
                        주문금액 <input type="text" name="item_sc_minimum" value="{{ $item_info->item_sc_minimum }}" id="item_sc_minimum" size="8" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"> 이상 무료 배송
                    </td>
                </tr>
                <tr id="sc_con_qty">
                    ...
                    <td>상품의 주문 수량에 따라 배송비가 부과됩니다. 예를 들어 기본배송비가 3,000원 수량을 3으로 설정했을 경우 상품의 주문수량이 5개이면 6,000원 배송비가 부과됩니다.<br>
                        주문수량 <input type="text" name="item_sc_qty" value="{{ $item_info->item_sc_qty }}" id="item_sc_qty" size="8" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"> 마다 배송비 부과
                    </td>
                </tr>

<script>
    $(function() {
        switch($("#item_sc_type option:selected").val()){
            case '1' :
                $("#sc_con_method").hide();
                $("#sc_con_basic").hide();
                $("#sc_con_minimum").hide();
